...
def compute_both_metrics(X, perts):
    ...
    Cosine distance uses the ops_model convention: L2-normalize each guide
    vector independently first, then compute centroids and similarity.
    (see ops_model/data/embeddings/cosine_similarity.py)
    ...
    # Cosine uses L2-normalized guide vectors (ops_model convention)
...
def main():
    ...
    parser.add_argument("--remove-bad", action="store_true",
                        help="Exclude bad experiments via ops_utils bad_experiments.yaml")
