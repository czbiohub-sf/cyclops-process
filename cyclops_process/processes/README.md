...
- `cp_features` — CellProfiler features (`cyclops_model.models.cellprofiler.cp_features`); array → concat → AnnData chain.
- `celldino_inference` — CellDINO embedding inference (`cyclops_model.features.batch_process_embeddings`).
